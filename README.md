...
- A test that iterates over all feeds, loads the content, and then ensures that an article title and article blurb exist for each feed. This test fails because the first feed generates a title, but no blurb.
